...
//http://www.javascriptobfuscator.com/Javascript-Obfuscator.aspx混淆
	...
	function qraa() { //网站LOGO正方形图片相对路径
		if (document.getElementById("showqr")) {} else {

			$("body").append('<div id="showqr" style="z-index:99999;position: fixed;' + LiftOrRight + ' top:0px;"><p align="center">' + myqrnote + '</p><img  id="logoimg" src="' + myqrlogimgsrc + '" style="display:none"/></div>');
		...
		if (logoimg.width < 1) {
			/*$("#logoimg").attr("src","http://www.aazj.cn/pc/meeting/img/home_tailogo.png");
var logoimg=document.getElementById("logoimg");*/
			logoimg.src = "";
		} else {
		...
		var thislogimgsrc = logoimg.src;
		if (thislogimgsrc.indexOf(thiswwwurl) >= 0) //避免图片跨域
		{
