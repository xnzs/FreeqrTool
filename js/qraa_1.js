...
//http://www.javascriptobfuscator.com/Javascript-Obfuscator.aspx混淆
	...
	function qraa(myurl) { //网站LOGO正方形图片相对路径
		if (document.getElementById("showqr")) {} else {

			$('body').append('<div id="showqr" style="z-index:99999;position: fixed;' + LiftOrRight + ' top:0px;"><p id="myqrnote" align="center">' + myqrnote + '</p><img  id="logoimg" src="' + myqrlogimgsrc + '" style="display:none"/></div>');
		...
		if (myqrlogimgsrc&&myqrlogimgsrc.indexOf(thiswwwurl) >= 0) //避免图片跨域
		{
